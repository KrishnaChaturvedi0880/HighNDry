...
public class HomeFragment extends Fragment {
    ...
    private void initData() {
        ...
        homeModelList.add(new HomeModel(R.drawable.bg_post1, "Tate Laundry", "₹500-₹700", "Distance 1.2 km"  ));
        homeModelList.add(new HomeModel(R.drawable.bg_post2, "Prince Laundry", "₹800-₹1000", "Distance 1.3 km" ));
        homeModelList.add(new HomeModel(R.drawable.bg_post3, "ATKT Laundry", "₹1000-₹1200", "Distance 1.4 km" ));
    }
