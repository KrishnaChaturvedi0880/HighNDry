...
public class SearchFragment extends Fragment {
    ...
    private void initData() {
        ...
        searchModelList.add(new SearchModel(R.drawable.bg_post1, "Adele Laundry \nCompany and Co.", "7.5", "Distance 1.5 km"));
        searchModelList.add(new SearchModel(R.drawable.bg_post2, "TopG Laundry \nCompany and Co.", "8.5", "Distance 2.5 km"));
        searchModelList.add(new SearchModel(R.drawable.bg_post3, "Money Laundry \nCompany and Co.", "9.5", "Distance 3.5 km"));
    }
